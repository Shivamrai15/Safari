...
const ArtistPage = async({
    ...
    return (
        <div className="min-h-full bg-neutral-950 pb-10">
            ...
            >
                <div className="h-full bg-gradient-to-b from-transparent to-neutral-950 relative">
                    <div className="bottom-0 absolute px-4 md:px-20">
            ...
            <div className="px-4 md:px-20 mt-5 flex items-center gap-6" >
            ...
            <div className="w-full px-4 md:px-20 mt-20 space-y-6">
