...
function TooltipContent({
  ...
  return (
    <TooltipPrimitive.Portal>
      ...
      >
        {children}
        <TooltipPrimitive.Arrow className="bg-secondary fill-secondary z-50 size-2.5 translate-y-[calc(-50%_-_2px)] rotate-45 rounded-[2px]" style={{ backgroundColor: color, fill : color }} />
      </TooltipPrimitive.Content>
    </TooltipPrimitive.Portal>
  )
}
